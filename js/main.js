...
const EXCEL_MAPPING = {
    ...
    financial_accounts: [
        // CHARGES (E)
        { code: 'TOTAL_G1', group: 'G1', label: "60 61 et 62 - Achats / services extérieurs / autres", type: 'expense' },
        ...
        { code: 'G1_OTHER', group: 'G1', label: "Autres", type: 'expense' },
        
        { code: 'TOTAL_G2', group: 'G2', label: "63- Impôts et taxes (TOTAL)", type: 'expense' },
        { code: 'TOTAL_G3', group: 'G3', label: "64- Charges de personnel (TOTAL)", type: 'expense' },
        { code: '64', group: 'G3', label: "Charges du personnel", type: 'expense' },
        { code: 'TOTAL_G4', group: 'G4', label: "65- Autres charges de gestion courante (TOTAL)", type: 'expense' },
        { code: 'TOTAL_G5', group: 'G5', label: "66- Charges financières (TOTAL)", type: 'expense' },
        { code: 'TOTAL_G6', group: 'G6', label: "67- Charges exceptionnelles (TOTAL)", type: 'expense' },
        { code: 'TOTAL_G7', group: 'G7', label: "68- Dot. aux amortis et aux provis. (TOTAL)", type: 'expense' },

        // RECETTES (R)
        { code: 'TOTAL_R1', group: 'R1', label: "70 à 73 - Produits des services (TOTAL)", type: 'revenue' },
        ...
        { code: 'R1_OTHER', group: 'R1', label: "Autres", type: 'revenue' },

        { code: 'TOTAL_R2', group: 'R2', label: "74- Subventions d'exploitation (TOTAL)", type: 'revenue' },
        ...
        { code: 'R2_OTHER', group: 'R2', label: "Autres", type: 'revenue' },

        { code: 'TOTAL_R3', group: 'R3', label: "76- Produits financiers (TOTAL)", type: 'revenue' },
        { code: 'TOTAL_R4', group: 'R4', label: "77- Produits exceptionnels (TOTAL)", type: 'revenue' },
        { code: 'TOTAL_R5', group: 'R5', label: "78 - Reprise sur Amortis. et provisions (TOTAL)", type: 'revenue' },
        { code: 'TOTAL_R6', group: 'R6', label: "79 - Transfert de charges (TOTAL)", type: 'revenue' },
        { code: 'TOTAL_R7', group: 'R7', label: "75 - Autres produits (TOTAL)", type: 'revenue' },

        // BILAN (B) - ACTIF
        { code: 'B_ACTIF_IMMO', group: 'B1', label: "TOTAL ACTIF IMMOBILISE", type: 'bilan' },
        { code: 'B_ACTIF_CIRC', group: 'B2', label: "TOTAL ACTIF CIRCULANT", type: 'bilan' },
        ...
        { code: 'B_ACTIF_TOTAL', group: 'B3', label: "TOTAL GENERAL ACTIF", type: 'bilan' },
        
        // BILAN (B) - PASSIF
        { code: 'B_PASSIF_FP', group: 'B4', label: "TOTAL FONDS PROPRES", type: 'bilan' },
        ...
        { code: 'B_PASSIF_DETTES', group: 'B7', label: "TOTAL DETTES", type: 'bilan' },
        ...
        { code: 'B_PASSIF_TOTAL', group: 'B8', label: "TOTAL GENERAL PASSIF", type: 'bilan' },
        { code: 'B_DIFF', group: 'B9', label: "DIFFERENCE ACTIF - PASSIF", type: 'bilan' }
    ]
};
